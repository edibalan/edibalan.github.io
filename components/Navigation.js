    ...
    return `
      ...
      <nav class="navigation | container">
        ...
        <ol class="navigation-content | container" role="list" type="I">
          ...
          ${this.renderNavigationLinks()}
          <a class="resume-button | fs-small fw-sm-bold" href="https://drive.google.com/file/d/1guefCuZIvgxyvhQP--7C_Ajze_98FkLx/view" download="Resume-Balan-Eduard.pdf" role="listitem" target="_blank">Resume</a>
        </ol>
      </nav>
